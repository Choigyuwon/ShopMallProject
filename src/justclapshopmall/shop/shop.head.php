    ...
    <div id="hd_wrapper">
		...
		<div class="hd_sch_wr">
	        <fieldset id="hd_sch">
	            ...
	            <button type="button" id="sch_submit2" font-size:100px;" onclick="location.href='https://gw2988.cafe24.com/zxc/aitest.php' " ><img src="<?php echo G5_DATA_URL; ?>/common/camara" width="50px"; height="50px";></button>
		    </form>
	            <script>
