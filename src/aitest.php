...
<script type="text/javascript">
    ...
    async function predict() {
        ...
        if(prediction[0].className == "blackbag" && prediction[0].probability.toFixed(2) == 1.00) {
            labelContainer.childNodes[0].innerHTML = "검정색 가방이다. 크로스백으로 요즘 많이 사용한다."
            location.href="../gc5/shop"
        } else if(prediction[1].className == "hair" && prediction[1].probability.toFixed(2) == 1.00) {
            labelContainer.childNodes[0].innerHTML = "놀이동산에서 구매할 수 있는 머리띠 이다."
        } else {
